  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-950/75 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-md rounded-3xl bg-white border border-slate-200 p-6 sm:p-8 shadow-2xl overflow-hidden">
        ...
        {/* Auth Mode Tabs (Only shown on non-Vercel environments) */}
        {!isVercelHost ? (
          ...
          <div className="mb-4 p-2.5 rounded-xl bg-teal-50 border border-teal-200 text-center">
            <p className="text-xs font-bold text-teal-900">Akses Administrator CBT Vercel</p>
            <p className="text-[10px] text-teal-700">Gunakan Kode Keamanan Master di bawah untuk verifikasi langsung</p>
          </div>
        )}
        ...
        {/* Tab 1: Google OAuth (Only available when not on Vercel) */}
        {!isVercelHost && loginTab === 'google' && (
        ...
        {(isVercelHost || loginTab === 'passcode') && (
