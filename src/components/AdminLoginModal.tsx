  ...
  const handleAdminGoogleLogin = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // If domain error, suggest passcode tab
        if (result.message.includes('Authorized Domains') || result.message.includes('auth/unauthorized-domain')) {
