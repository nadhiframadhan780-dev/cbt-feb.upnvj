...
export const Navbar: React.FC<NavbarProps> = ({ 
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-md border-b border-slate-200/80 transition-colors shadow-xs">
          ...
          <div className="flex items-center justify-between h-16 sm:h-18 gap-3">
            ...
            >
              ...
              <div className="flex flex-col text-left shrink-0">
                ...
                <span className="text-[10px] sm:text-[11px] text-slate-500 font-medium tracking-tight leading-none whitespace-nowrap hidden xs:block">
              ...
              {isAuthenticated ? (
                <div className="relative shrink-0">
                  <button
                    ...
                    className="flex items-center gap-2 pl-1.5 pr-2.5 sm:pr-3 py-1 rounded-full border border-slate-200 bg-slate-50/80 hover:bg-slate-100 hover:border-slate-300 transition-all cursor-pointer shrink-0"
                  >
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full overflow-hidden bg-teal-700 text-white flex items-center justify-center font-bold text-xs ring-1 ring-teal-600/30 shrink-0">
                      {user?.photoURL ? (
                        <img 
                          src={user.photoURL} 
                    ...
                    <div className="text-left hidden sm:block shrink-0">
                      <p className="text-xs font-semibold text-slate-800 truncate max-w-[110px] sm:max-w-[130px] leading-tight">
        ...
        {/* Mobile Drawer Menu */}
        {mobileMenuOpen && (
          <div className="xl:hidden border-t border-slate-200 bg-white px-4 pt-3 pb-6 space-y-1.5 shadow-lg">
            {isAuthenticated && (
